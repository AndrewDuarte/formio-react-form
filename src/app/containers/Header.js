        ...
        <nav className="navbar navbar-default navbar-static-top">
          <div className="container">
            <div className="navbar-header">
              ...
              <IndexLink className="navbar-brand" to="/"><img className="logo" alt="http://andrewduarte.com.au" src="http://andrewduarte.com.au/wp-content/uploads/Andrew-Duarte-Logo-02.svg" /></IndexLink>
            </div>
